...
var Menu = function (_a) {
    ...
    var _b = react.exports.useState(0), activeIndex = _b[0], setActiveIndex = _b[1];
    ...
    var handleItemClick = react.exports.useCallback(function (i) {
        if (!controlledId) {
            setActiveIndex(i);
        }
        if (onChange) {
    ...
    return (React.createElement("div", { className: 'navigation', style: styles.navigation },
        React.createElement("ul", null,
            ...
            React.createElement("div", { className: 'indicator', style: __assign$1(__assign$1({}, styles.indicator), { transform: "translateX(calc(70px * ".concat(activeIndex, ")") }) },
...
[
    ...
    {
        name: "Map",
        icon: React.createElement(IoLocationOutline, null),
    },
    {
        name: "Profile",
        icon: React.createElement(IoPersonOutline, null),
    },
    {
        name: "Friends",
        icon: React.createElement(IoPeopleOutline, null),
    },
    {
        name: "Settings",
        icon: React.createElement(IoSettingsOutline, null),
    },
];
